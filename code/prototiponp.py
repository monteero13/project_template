...
STRING_FILE = "string_network_filtered_hugo-400.tsv"  # Archivo de interacciones de STRINGdb
SEED_GENES = ["WNT10B", "SEM1", "WT1", "PAX6", "NF1"]  # Genes semilla en formato HUGO
STRING_SCORE_THRESHOLD = 400  # Umbral de puntaje de interacción
...
def main():
    try:
        ...
        output_file = os.path.join(results_dir, "subgraph_diamond.tsv")
