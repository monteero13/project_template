...
# Leer la red desde un archivo TXT
network_file <- "string_interactions_short.tsv"
edges <- read.table(network_file, header = FALSE, sep = "\t")

# Extraer solo las dos primeras columnas (V1 y V2), que representan los nodos de las aristas
edges <- edges[, c(1, 2)]

# Crear el grafo desde las dos primeras columnas (nodo1, nodo2)
g <- graph_from_edgelist(as.matrix(edges), directed = FALSE)

# Aplicar el algoritmo Fast Greedy para encontrar las comunidades
