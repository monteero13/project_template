...
\begin{figure}[!h] % [h] indica que queremos la imagen aquí, en la posición actual
	\centering
	\includegraphics[scale=0.7]{figures/redCoefClustering.png} % Especifica la ruta y el tamaño
	\caption{Red según coeficiente de clustering local} % Agrega una leyenda si deseas
	\label{fig:redCoefClustering}
\end{figure}

\begin{figure}[!h] % [h] indica que queremos la imagen aquí, en la posición actual
	\centering
	\includegraphics[scale=0.7]{figures/redBetweenness.png} % Especifica la ruta y el tamaño
	\caption{Red según índice de centralidad de intermediación} % Agrega una leyenda si deseas
	\label{fig:redBetweenness}
\end{figure}

Además, para cada nodo hemos calculado el coeficiente de clustering local, el grado de centralidad y su centralidad de intermediación, toda esta información puede observarse en la tabla \ref{tab:parametros_nodos_red}. 
\begin{table}[ht]
	\centering
...
\begin{figure}[!h] % [h] indica que queremos la imagen aquí, en la posición actual
	\centering
	\includegraphics[width=1\textwidth]{figures/graph_no_weights.png} % Especifica la ruta y el tamaño
	\caption{Red resultante al propagar con WNT10B, WT1, SEM1, PAX6, y NF1} % Agrega una leyenda si deseas
